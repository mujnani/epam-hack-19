                                            ...
                                            <div className="widget-chart-content text-white">
                                                <div className="icon-wrapper rounded">
                                                    ...
                                                    <div className="icon-wrapper-bg bg-white opacity-10 pt-2">
                                                        <img width={40} className="rounded" src={bankLogo1} alt=""/>
                                                    </div>
                                                </div>
                                                <div className="widget-numbers">
                                                    ￥87.4K
                                        ...
                                        <div className="card mb-3 bg-midnight-bloom widget-chart text-white card-border">
                                            <div className="widget-chart-content text-white">
                                                <div className="icon-wrapper rounded">
                                                    ...
                                                    <div className="icon-wrapper-bg bg-white opacity-10 pt-2">
                                                        <img width={40} className="rounded" src={bankLogo2} alt=""/>
                                                    </div>
                                                </div>
                                                <div className="widget-numbers">
                                                    ￥17.7K
                                        ...
                                        <div className="card mb-3 bg-midnight-bloom widget-chart text-white card-border">
                                            <div className="widget-chart-content text-white">
                                                <div className="icon-wrapper rounded">
                                                    ...
                                                    <div className="icon-wrapper-bg bg-white opacity-10 pt-2">
                                                        <img width={40} className="rounded" src={bankLogo3} alt=""/>
                                                    </div>
                                                </div>
                                                <div className="widget-numbers">
                                                    ￥3.2K
                        ...
                        <Row>
                            <Col md="12">
                                <Card className="main-card mb-3">
                                    <div className="card-header">Transactions
                                        <div className="btn-actions-pane-right">
                                            <div role="group" className="btn-group-sm btn-group">
                                                <button className="active btn btn-info">Last Week</button>
                                                <button className="btn btn-info">Last Month</button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="widget-content p-0">
                                                        <div className="widget-content-wrapper">
                                                            <div className="widget-content-left mr-3">
                                                                <div className="widget-content-left rounded-circle">
                                                                    <i className="pe-7s-cup text-info"/>
                                                                    {/* <img width={40} className="rounded-circle" src={avatar4} alt="Avatar" /> */}
                                                                </div>
                                                            </div>
                                                            <div className="widget-content-left flex2">
                                                                <div className="widget-heading">Food & Beverages</div>
                                                        ...
                                                        <div className="widget-content-wrapper">
                                                            <div className="widget-content-left mr-3">
                                                                <div className="widget-content-left">
                                                                    <i className="pe-7s-car text-info"/>
                                                                    {/* <img width={40} className="rounded-circle" src={avatar3} alt="Avatar" /> */}
                                                                </div>
                                                            </div>
                                                            <div className="widget-content-left flex2">
                                                                <div className="widget-heading">Transportation</div>
                                                ...
                                                <td>
                                                    <div className="widget-content p-0">
                                                        <div className="widget-content-wrapper">
                                                            <div className="widget-content-left mr-3">
                                                                <div className="widget-content-left">
                                                                    <i className="pe-7s-wristwatch text-info"/>
                                                                    {/* <img width={40} className="rounded-circle" src={avatar2} alt="Avatar" /> */}
                                                                </div>
                                                            </div>
                                                            <div className="widget-content-left flex2">
                                                                <div className="widget-heading">Clothes & Beauty</div>
                                                ...
                                                <td>
                                                    <div className="widget-content p-0">
                                                        <div className="widget-content-wrapper">
                                                            <div className="widget-content-left mr-3">
                                                                <div className="widget-content-left">
                                                                    <i className="pe-7s-home text-info"/>
                                                                </div>
                                                            </div>
                                                            <div className="widget-content-left flex2">
                                                                <div className="widget-heading">Housing property</div>
                                                ...
                                                <td>
                                                    <div className="widget-content p-0">
                                                        <div className="widget-content-wrapper">
                                                            <div className="widget-content-left mr-3">
                                                                <div className="widget-content-left">
                                                                    <i className="pe-7s-diamond text-info"/>
                                                                </div>
                                                            </div>
                                                            <div className="widget-content-left flex2">
                                                                <div className="widget-heading">Everyday Objects</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div className="widget-content p-0">
                                                        <div className="widget-content-wrapper">
                                                            <div className="widget-content-left mr-3">
                                                                <div className="widget-content-left">
                                                                    <i className="pe-7s-piggy text-info"/>
                                                                </div>
                                                            </div>
                                                            <div className="widget-content-left flex2">
                                                                <div className="widget-heading">Investment & Financing</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div className="widget-content p-0">
                                                        <div className="widget-content-wrapper">
                                                            <div className="widget-content-left mr-3">
                                                                <div className="widget-content-left">
                                                                    <i className="pe-7s-plugin text-info"/>
                                                                </div>
                                                            </div>
                                                            <div className="widget-content-left flex2">
                                                                <div className="widget-heading">Others</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
